...
public class PolyDrawExample2 : MonoBehaviour
{
    ...
    private void Start()
    {
        Debug.Log(Mathf.Asin(0.5f) + " Asin");
        Debug.Log(Mathf.Tan(0.5F) + " Tan");
        Debug.Log(Mathf.Acos(0.5f) + " Acos");
        Debug.Log(Mathf.Atan(0.5f) + " Atan");
    }
